...
with open(filename,'w',encoding='utf-8',newline='') as output_file:
	writer = csv.DictWriter(output_file,fieldnames=column_names, quoting=csv.QUOTE_NONNUMERIC, extrasaction='ignore')  #extrasaction = pozwala na wykluczenie country
	writer.writeheader()
